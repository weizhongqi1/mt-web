  ...
  <div class="page-login">
    ...
    <div class="login-panel">
      ...
      <div class="form">
        ...
        <el-input :class="{error : error && !userName}" placeholder="手机号/用户名/邮箱" prefix-icon="profile" v-model="userName"></el-input>
        <el-input :class="{error : error && !passWord}" placeholder="密码" prefix-icon="password" v-model="passWord" type="password"></el-input>
        <div class="foot">
          <a>忘记密码？</a>
        </div>
